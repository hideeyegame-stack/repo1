        ...
        <div className="w-full grid gap-6">
          ...
          <section className="grid gap-3">
            ...
            <div className="flex gap-4">
              <div className="border rounded p-4">Free Fire</div>
            </div>
          </section>
          <section className="grid gap-3">
            <h2 className="text-xl font-semibold">Upcoming Matches</h2>
            <p>Admin managed tournaments will appear here.</p>
          </section>
          <section className="grid gap-3">
            <h2 className="text-xl font-semibold">Points</h2>
            <div className="flex items-center justify-between">
              <span>Current points: 0</span>
              <Link href="/profile" className="px-3 py-2 rounded bg-black text-white">Top up</Link>
            </div>
          </section>
        </div>
